...
export default function BlogPostPage({ params }: { params: Promise<{ id: string }> }) {
  // Unwrap the params promise using 'use' hook (Next.js 15+ standard)
  ...
  if (error || !blog) return (
    <div className="min-h-screen flex flex-center flex-col items-center justify-center gap-4">
      <p className="font-mono text-xs uppercase opacity-50">Entry Not Found</p>
      <Link href="/blogs" className="underline text-xs">Return to Archive</Link>
    </div>
  );
